...
//         sessionStorage.setItem("orderDetails", JSON.stringify({ formData, cart, orderId: generatedOrderId }));
//     };
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] p-6">
      <div className="flex flex-col lg:flex-row justify-center max-w-7xl mx-auto gap-8">
        {/* Left Section: Form */}
        <div className="bg-white w-full lg:w-[440px] p-6">
          <h1 className="text-[21px] font-medium mb-4">
          ...
          <form className="space-y-6" onSubmit={handleFormSubmit}>
            <span className="text-[21px] font-medium text-[#111111]">
