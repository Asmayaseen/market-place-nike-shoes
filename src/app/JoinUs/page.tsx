        ...
        <form className="mt-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <button
              ...
              className={`flex-1 py-2 border rounded-md text-center ${gender === "Male" ? "bg-gray-200" : "hover:bg-gray-100"}`}
            >
              Male
            </button>
            <button
              ...
              className={`flex-1 py-2 border rounded-md text-center ${gender === "Female" ? "bg-gray-200" : "hover:bg-gray-100"}`}
            >
              Female
            </button>
          </div>
